namespace Bunchkins.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Bunchkins.Infrastructure.BunchkinsDataContext>
    {
        ...
        protected override void Seed(Bunchkins.Infrastructure.BunchkinsDataContext context)
        {
            ...
            {
                //Door Cards
                context.Cards.Add(new BuffMonsterSpellDoorCard { Description = "Play During Combat. +5 to Monster Level. Active Player Gains 1 Additional Treasure Upon Monster Defeat", FlavorText = "You'll like him when he's angry. If you aren't the one fighting.", Name = "Enraged Monster", CombatPower = 5, TreasureChange = 1, Type = "CombatSpell" });
                context.Cards.Add(new BuffMonsterSpellDoorCard { Description = "Play During Combat. +5 to Monster Level. Active Player Gains 1 Additional Treasure Upon Monster Defeat", FlavorText = "The square root of pie is, IT'S EATING ME!!!!", Name = "Intelligent Monster", CombatPower = 5, TreasureChange = 1, Type = "CombatSpell" });
                context.Cards.Add(new BuffMonsterSpellDoorCard { Description = "Play During Combat. +10 to Monster Level. Active Player Gains 2 Additional Treasure Upon Monster Defeat", FlavorText = "Her fingers will blot out the sun.", Name = "Humongous Monster", CombatPower = 10, TreasureChange = 2, Type = "CombatSpell" });
                context.Cards.Add(new BuffMonsterSpellDoorCard { Description = "Play During Combat. +10 to Monster Level. Active Player Gains 2 Additional Treasure Upon Monster Defeat", FlavorText = "The oldest of schools.", Name = "Ancient Monster", CombatPower = 10, TreasureChange = 2, Type = "CombatSpell" });
                context.Cards.Add(new BuffMonsterSpellDoorCard { Description = "Play During Combat. -5 to Monster Level. Active Player Gains 1 Less Treasure Upon Monster Defeat", FlavorText = "TOO.....CUTE....Gonna....DIE.", Name = "Baby Monster", CombatPower = -5, TreasureChange = -1, Type = "CombatSpell" });
                ...
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "It came from THE TAP!!!!", Name = "Bottled Terror Water", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "Try not to fall over.", Name = "A Light Breeze", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "Warning: Do Not Place Over Head.", Name = "Trash Bag Of Death", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "Just give up the candy before we all get killed.", Name = "Kindergartener", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "It's only weakness is a tissue.", Name = "Mutant Snot", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "Seriously, just take them off your face.", Name = "Broken Glasses", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                context.Cards.Add(new LevelDecreaseMonsterCard { Description = "Bad Stuff: Lose 1 Levels", FlavorText = "You know he's coming when you hear the snaps.", Name = "Cole", Level = 1, LevelGain = 1, TreasureGain = 1, LevelsDecreased = 1, Type = "Monster" });
                ...
                context.Cards.Add(new DeathMonsterCard { Description = "Minimum Pursuit Level: 6, Bad Stuff: Die for being delicious.", FlavorText = "Radiation levels OVER 9000!!!", Name = "Plutonium Dragon", Level = 20, TreasureGain = 5, LevelGain = 2, MinPursuitLevel = 6, Type = "Monster" });
                ...
                context.Cards.Add(new LoseHandCardsCurseCard { Description = "Target Player Loses 3 Cards from Hand", FlavorText = "Just add water and wait 3 minutes.", Name = "Noodle Brain", NumCards = 3, Type = "Curse" });
                context.Cards.Add(new LoseHandCardsCurseCard { Description = "Target Player Loses 1 Card from Hand", FlavorText = "Is that Big Foot?", Name = "Look Over There", NumCards = 1, Type = "Curse" });
                ...
                context.Cards.Add(new VanquishMonsterSpellCard { Description = "Destroy Monsters in Current Combat. Active Player Gains Treasures that would be earned.", FlavorText = "That golem looks tough...aaaaannnd its a rooster.", Name = "Polymorph Potion", Gold = 1300, Type = "CombatSpell" });
                context.Cards.Add(new VanquishMonsterSpellCard { Description = "Destroy Monsters in Current Combat. Active Player Gains Treasures that would be earned.", FlavorText = "You get one wish. Alladin was a liar", Name = "Magic Lamp", Gold = 500, Type = "CombatSpell" });
                ...
                context.Cards.Add(new EquipmentCard { Description = "Equipment Slot: Headgear,  Combat Power Bonus: +3", FlavorText = "It wouldn't be the same if it wasn't pointy.", Slot = "Headgear", Gold = 400, Bonus = 3, Name = "Pointy Hat of Power", Type = "Equipment" });
                ...
                context.Cards.Add(new EquipmentCard { Description = "Equipment Slot: 1 Hand,  Combat Power Bonus: +2", FlavorText = "Your dad bought you this. Oh wait...", Slot = "1Hand", Gold = 400, Bonus = 2, Name = "Sneaky Bastard Sword", Type = "Equipment" });
